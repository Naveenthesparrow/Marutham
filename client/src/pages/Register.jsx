...
const Register = () => {
    ...
    return (
        <div className="min-h-[90vh] flex items-center justify-center bg-nature-bg px-4 py-12">
            <motion.div
            ...
            >
                <div className="bg-white rounded-[2.5rem] p-10 shadow-xl border border-nature-border">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-3xl font-display font-bold text-stone-900">Join Marutham</h1>
                        <p className="text-stone-500 mt-2">Create an account to start bulk sourcing</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="block text-sm font-bold text-stone-700 mb-2 uppercase tracking-widest px-1">Full Name</label>
                        ...
                        <div>
                            <label className="block text-sm font-bold text-stone-700 mb-2 uppercase tracking-widest px-1">Merchant Address</label>
                            <div className="relative">
